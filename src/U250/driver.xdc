...
create_clock -period 8.000 -waveform {0.000 4.000} -add [get_ports USER_SI570_CLOCK_N]
create_clock -period 8.000 -waveform {0.000 4.000} -add [get_ports USER_SI570_CLOCK_P]
#
